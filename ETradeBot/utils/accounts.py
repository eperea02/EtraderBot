            ...
            if (
                ...
                while True:
                    ...
                    for account in accounts:
                        ...
                        if (
                            account is not None
                            and "accountDesc" in account
                            and account["accountDesc"].strip() is not None
                        ):
                            print_str = (
                                print_str + ", " + account["accountDesc"].strip()
                            )
        ...
        if response is not None and response.status_code == 200:
            ...
            if data is not None and "BalanceResponse" in data:
                ...
                if (
                    ...
                    and "Computed" in balance_data
                    and "RealTimeValues" in balance_data["Computed"]
                    and "totalAccountValue"
                    in balance_data["Computed"]["RealTimeValues"]
                ):
                    print(
                        "Net Account Value: "
                        + str(
                            "${:,.2f}".format(
                                balance_data["Computed"]["RealTimeValues"][
                                    "totalAccountValue"
                                ]
                            )
                        )
                ...
                if (
                    ...
                    print(
                        ...
                        + str(
                            "${:,.2f}".format(
                                balance_data["Computed"]["marginBuyingPower"]
                            )
                        )
                    )
                if (
                    ...
                    print(
                        ...
                        + str(
                            "${:,.2f}".format(
                                balance_data["Computed"]["cashBuyingPower"]
                            )
                        )
                    )
            else:
